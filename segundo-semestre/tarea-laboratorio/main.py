...
def limpiar_cant_precio(cant_precio):
    cant_precio_limpio = []
...
def calcular_total(cant_precio_limpio):
    cantidad = 0
    p_unitario = 0
    i = 1
...
def salida_datos(cantidad, p_unitario):
